...
export const tenants = pgTable("tenants", {
  ...
  metaBusinessId: text("meta_business_id").default(""),
  metaPhoneStatus: text("meta_phone_status").default(""),
  metaCodeVerificationStatus: text("meta_code_verification_status").default(""),
  metaDisplayNameStatus: text("meta_display_name_status").default(""),
  metaBusinessVerificationStatus: text("meta_business_verification_status").default(""),
